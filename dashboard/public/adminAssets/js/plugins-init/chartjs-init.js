(function($) {
 ...
 var dlabSparkLine = function(){
	...
	var residentialPieChart = function(){
		//pie chart
		const propertyData = document.getElementById('urlparserdata').textContent;
		const myObject = JSON.parse(propertyData);
		// console.log(myObject);

		const labels = myObject.map(item => item.name);
		const propert_count = myObject.map(item => item.property_count);
		// console.log(labels,propert_count);
		




		if(jQuery('#residential_prop_pie_chart').length > 0 ){
			//pie chart
			const pie_chart = document.getElementById("residential_prop_pie_chart").getContext('2d');
	...
	var commercialPieChart = function(){

		const propertyData = document.getElementById('urlparserdata2').textContent;
		const myObject = JSON.parse(propertyData);
		// console.log(myObject);
		...
		//pie chart
		if(jQuery('#commercial_prop_pie_chart').length > 0 ){
			//pie chart
			const pie_chart = document.getElementById("commercial_prop_pie_chart").getContext('2d');
			// pie_chart.height = 100;
			new Chart(pie_chart, {
				type: 'pie',
				data: {
